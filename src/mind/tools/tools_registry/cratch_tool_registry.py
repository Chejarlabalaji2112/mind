...
class ToolRegistry:
    ...
    def __init__(self, presenters: list[Presenter], output_tuner=None,loop=None):
        ...
        if output_tuner is None or loop is None:
            raise ValueError("output_tuner/loop must be provided")
        self.loop = loop 
